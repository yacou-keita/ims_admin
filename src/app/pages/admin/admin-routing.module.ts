...
const routes: Routes = [
  ...
  { path: 'menuofyear', loadChildren: () => import('./menu-of-year/menu-of-year.module').then(m => m.MenuOfYearModule), canActivate:[RoleGuard],data: {role_name: USERROLE.Admin} },
  { path: 'users', loadChildren: () => import('./users/users.module').then(m => m.UsersModule), canActivate:[RoleGuard],data: {role_name: USERROLE.Admin} },
  { path: 'users/:id', loadChildren: () => import('./user-detail/user-detail.module').then(m => m.UserDetailModule), canActivate:[RoleGuard],data: {role_name: USERROLE.Admin} },
  { path: 'notification', loadChildren: () => import('./notification/notification.module').then(m => m.NotificationModule), canActivate:[RoleGuard],data: {role_name: USERROLE.Admin} },
