...
const routes: Routes = [
  ...
  { path: 'teachers', loadChildren: () => import('./users/users.module').then(m => m.UsersModule), canActivate:[RoleGuard],data: {role: USERROLE.Admin} },
  { path: 'teachers/:id', loadChildren: () => import('./user-detail/user-detail.module').then(m => m.UserDetailModule), canActivate:[RoleGuard],data: {role: USERROLE.Admin} },
